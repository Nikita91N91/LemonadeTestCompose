package com.example.lemonadetestcompose
...
import com.example.lemonadetestcompose.ui.theme.LemonadeTestComposeTheme
            ...
            when (currentStep) {
                1 -> {
                    LemonTextAndImage(
                        ...
                        contentDescriptionResourceId = R.string.tap_to_select_lemon,
                        onImageClick = {
                            currentStep = 2
                ...
                2 -> {
                    LemonTextAndImage(
                        ...
                        contentDescriptionResourceId = R.string.keep_tapping_to_squeeze,
                        onImageClick = {
                            squeezeCount--
                            if (squeezeCount == 0)
                                currentStep = 3
                ...
                3 -> {
                    LemonTextAndImage(
                        ...
                        contentDescriptionResourceId = R.string.tap_lemonade_to_drink,
                ...
                4 -> {
                    LemonTextAndImage(
                        ...
                        contentDescriptionResourceId = R.string.empty_glass_to_start,
